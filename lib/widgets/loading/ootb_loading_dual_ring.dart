...
class OTLDualRing extends StatefulWidget {
  const OTLDualRing({
    super.key,
    required this.color,
    this.lineWidth = 7.0,
  ...
  @override
  State<OTLDualRing> createState() => _OTLDualRingState();
}

class _OTLDualRingState extends State<OTLDualRing> with SingleTickerProviderStateMixin {
