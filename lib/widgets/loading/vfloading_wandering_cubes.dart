...
class VFLWanderingCubes extends StatefulWidget {
  const VFLWanderingCubes({
    super.key,
    this.color,
  ...
  @override
  State<VFLWanderingCubes> createState() => _VFLWanderingCubesState();
}

class _VFLWanderingCubesState extends State<VFLWanderingCubes> with SingleTickerProviderStateMixin {
