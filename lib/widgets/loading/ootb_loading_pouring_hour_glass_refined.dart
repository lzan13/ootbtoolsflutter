...
class OTLPouringHourGlassRefined extends StatefulWidget {
  const OTLPouringHourGlassRefined({
    super.key,
    required this.color,
    this.size = 50.0,
  ...
  @override
  State<OTLPouringHourGlassRefined> createState() => _OTLPouringHourGlassRefinedState();
}

class _OTLPouringHourGlassRefinedState extends State<OTLPouringHourGlassRefined> with SingleTickerProviderStateMixin {
