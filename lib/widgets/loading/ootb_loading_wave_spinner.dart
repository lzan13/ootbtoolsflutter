...
class OTLWaveSpinner extends StatefulWidget {
  const OTLWaveSpinner({
    super.key,
    required this.color,
  ...
  @override
  State<OTLWaveSpinner> createState() => _OTLWaveSpinnerState();
}

class _OTLWaveSpinnerState extends State<OTLWaveSpinner> with SingleTickerProviderStateMixin {
