...
class OTLRotatingPlain extends StatefulWidget {
  const OTLRotatingPlain({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<OTLRotatingPlain> createState() => _OTLRotatingPlainState();
}

class _OTLRotatingPlainState extends State<OTLRotatingPlain> with SingleTickerProviderStateMixin {
