...
class VFLSpinningLines extends StatefulWidget {
  const VFLSpinningLines({
    super.key,
    required this.color,
    this.size = 70,
    this.lineWidth = 2.0,
  ...
  @override
  State<VFLSpinningLines> createState() => _VFLSpinningLinesState();
}

class _VFLSpinningLinesState extends State<VFLSpinningLines> with SingleTickerProviderStateMixin {
