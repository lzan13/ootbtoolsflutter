...
class OTLPulsingGrid extends StatefulWidget {
  const OTLPulsingGrid({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<OTLPulsingGrid> createState() => _OTLPulsingGridState();
}

class _OTLPulsingGridState extends State<OTLPulsingGrid> with SingleTickerProviderStateMixin {
