...
class VFLRotatingPlain extends StatefulWidget {
  const VFLRotatingPlain({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<VFLRotatingPlain> createState() => _VFLRotatingPlainState();
}

class _VFLRotatingPlainState extends State<VFLRotatingPlain> with SingleTickerProviderStateMixin {
