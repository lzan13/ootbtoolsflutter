...
class OTLHourGlass extends StatefulWidget {
  const OTLHourGlass({
    super.key,
    required this.color,
    this.size = 50.0,
  ...
  @override
  State<OTLHourGlass> createState() => _OTLHourGlassState();
}

class _OTLHourGlassState extends State<OTLHourGlass> with SingleTickerProviderStateMixin {
