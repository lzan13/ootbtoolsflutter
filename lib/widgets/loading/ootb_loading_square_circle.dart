...
class OTLSquareCircle extends StatefulWidget {
  const OTLSquareCircle({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<OTLSquareCircle> createState() => _OTLSquareCircleState();
}

class _OTLSquareCircleState extends State<OTLSquareCircle> with SingleTickerProviderStateMixin {
