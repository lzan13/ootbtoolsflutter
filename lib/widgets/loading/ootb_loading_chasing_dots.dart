...
class OTLChasingDots extends StatefulWidget {
  const OTLChasingDots({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<OTLChasingDots> createState() => _OTLChasingDotsState();
}

class _OTLChasingDotsState extends State<OTLChasingDots> with TickerProviderStateMixin {
