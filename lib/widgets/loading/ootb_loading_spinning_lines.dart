...
class OTLSpinningLines extends StatefulWidget {
  const OTLSpinningLines({
    super.key,
    required this.color,
    this.size = 70,
    this.lineWidth = 2.0,
  ...
  @override
  State<OTLSpinningLines> createState() => _OTLSpinningLinesState();
}

class _OTLSpinningLinesState extends State<OTLSpinningLines> with SingleTickerProviderStateMixin {
