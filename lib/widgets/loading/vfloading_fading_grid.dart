...
class VFLFadingGrid extends StatefulWidget {
  const VFLFadingGrid({
    super.key,
    this.color,
  ...
  @override
  State<VFLFadingGrid> createState() => _VFLFadingGridState();
}

class _VFLFadingGridState extends State<VFLFadingGrid> with SingleTickerProviderStateMixin {
