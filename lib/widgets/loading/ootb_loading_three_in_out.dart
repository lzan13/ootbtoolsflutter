...
class OTLThreeInOut extends StatefulWidget {
  const OTLThreeInOut({
    super.key,
    this.color,
    this.size = 50.0,
  ...
  @override
  State<OTLThreeInOut> createState() => _OTLThreeInOutState();
}

class _OTLThreeInOutState extends State<OTLThreeInOut> with SingleTickerProviderStateMixin {
