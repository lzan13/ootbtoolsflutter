...
class VFLPouringHourGlass extends StatefulWidget {
  const VFLPouringHourGlass({
    super.key,
    required this.color,
    this.size = 50.0,
  ...
  @override
  State<VFLPouringHourGlass> createState() => _VFLPouringHourGlassState();
}

class _VFLPouringHourGlassState extends State<VFLPouringHourGlass> with SingleTickerProviderStateMixin {
