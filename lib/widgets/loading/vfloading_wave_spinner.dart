...
class VFLWaveSpinner extends StatefulWidget {
  const VFLWaveSpinner({
    super.key,
    required this.color,
  ...
  @override
  State<VFLWaveSpinner> createState() => _VFLWaveSpinnerState();
}

class _VFLWaveSpinnerState extends State<VFLWaveSpinner> with SingleTickerProviderStateMixin {
