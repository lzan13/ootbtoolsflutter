...
class VFLSquareCircle extends StatefulWidget {
  const VFLSquareCircle({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<VFLSquareCircle> createState() => _VFLSquareCircleState();
}

class _VFLSquareCircleState extends State<VFLSquareCircle> with SingleTickerProviderStateMixin {
