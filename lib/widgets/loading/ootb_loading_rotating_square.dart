...
class OTLRotatingSquare extends StatefulWidget {
  final Color color;
  final double size;
  ...
  @override
  OTLRotatingSquareState createState() => OTLRotatingSquareState();
}

class OTLRotatingSquareState extends State<OTLRotatingSquare> with SingleTickerProviderStateMixin {
