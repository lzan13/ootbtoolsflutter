...
class OTLRipple extends StatefulWidget {
  final Color color;
  final double size;
  ...
  @override
  OTLRippleState createState() => OTLRippleState();
}

class OTLRippleState extends State<OTLRipple> with TickerProviderStateMixin {
