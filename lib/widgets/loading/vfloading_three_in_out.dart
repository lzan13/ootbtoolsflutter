...
class VFLThreeInOut extends StatefulWidget {
  const VFLThreeInOut({
    super.key,
    this.color,
    this.size = 50.0,
  ...
  @override
  State<VFLThreeInOut> createState() => _VFLThreeInOutState();
}

class _VFLThreeInOutState extends State<VFLThreeInOut> with SingleTickerProviderStateMixin {
