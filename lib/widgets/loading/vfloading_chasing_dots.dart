...
class VFLChasingDots extends StatefulWidget {
  const VFLChasingDots({
    super.key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  State<VFLChasingDots> createState() => _VFLChasingDotsState();
}

class _VFLChasingDotsState extends State<VFLChasingDots> with TickerProviderStateMixin {
