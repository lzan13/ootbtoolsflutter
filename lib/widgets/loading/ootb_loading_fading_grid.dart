...
class OTLFadingGrid extends StatefulWidget {
  const OTLFadingGrid({
    super.key,
    this.color,
  ...
  @override
  State<OTLFadingGrid> createState() => _OTLFadingGridState();
}

class _OTLFadingGridState extends State<OTLFadingGrid> with SingleTickerProviderStateMixin {
