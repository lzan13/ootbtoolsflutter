...
class VFLPouringHourGlassRefined extends StatefulWidget {
  const VFLPouringHourGlassRefined({
    super.key,
    required this.color,
    this.size = 50.0,
  ...
  @override
  State<VFLPouringHourGlassRefined> createState() => _VFLPouringHourGlassRefinedState();
}

class _VFLPouringHourGlassRefinedState extends State<VFLPouringHourGlassRefined> with SingleTickerProviderStateMixin {
