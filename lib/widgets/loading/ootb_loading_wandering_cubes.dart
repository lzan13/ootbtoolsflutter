...
class OTLWanderingCubes extends StatefulWidget {
  const OTLWanderingCubes({
    super.key,
    this.color,
  ...
  @override
  State<OTLWanderingCubes> createState() => _OTLWanderingCubesState();
}

class _OTLWanderingCubesState extends State<OTLWanderingCubes> with SingleTickerProviderStateMixin {
