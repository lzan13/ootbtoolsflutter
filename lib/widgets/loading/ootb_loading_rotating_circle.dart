...
class OTLRotatingCircle extends StatefulWidget {
  final Color color;
  final double size;
  ...
  @override
  _OTLRotatingCircleState createState() => _OTLRotatingCircleState();
}

class _OTLRotatingCircleState extends State<OTLRotatingCircle> with SingleTickerProviderStateMixin {
