...
class OTLFadingFour extends StatefulWidget {
  const OTLFadingFour({
    super.key,
    this.color,
  ...
  @override
  State<OTLFadingFour> createState() => _OTLFadingFourState();
}

class _OTLFadingFourState extends State<OTLFadingFour> with SingleTickerProviderStateMixin {
