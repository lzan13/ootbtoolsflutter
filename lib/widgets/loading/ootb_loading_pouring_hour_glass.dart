...
class OTLPouringHourGlass extends StatefulWidget {
  const OTLPouringHourGlass({
    super.key,
    required this.color,
    this.size = 50.0,
  ...
  @override
  State<OTLPouringHourGlass> createState() => _OTLPouringHourGlassState();
}

class _OTLPouringHourGlassState extends State<OTLPouringHourGlass> with SingleTickerProviderStateMixin {
